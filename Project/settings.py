...
SECRET_KEY = 'django-insecure-tuu&jvxvnt@hs+x!rww47fc5vz@x!z2-$k@d$on(4j5rvut=ih'
...
INSTALLED_APPS = [
    ...
    'storages',                   ## this is for file storage 
    'corsheaders',
    'rest_framework',
...
AUTHENTICATION_BACKENDS = [
    'account.custom_auth.CustomEmployeeAuthentication',
